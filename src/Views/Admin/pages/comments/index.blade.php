            ...
            <div class="col-md-12">
                <div class="card m-b-30">
                    <form action="" method="GET" class="mt-4 d-flex justify-content-between">
                        <div class="card-body">
                            <h2 class="mb-4">
                                <span class="badge badge-default"> List Post </span>
                            </h2>
                            ...
                            <div class="table-responsive">
                                <table class="table table-bordered mb-0">
                                    ...
                                    <tbody class="table-group-divider">
                                        ...
                                        @empty($posts)
                                            <tr>
                                                <td colspan="6" class="text-center">No Post Here</td>
                                            </tr>
                                        @endempty
                                        @foreach ($posts as $post)
                                            <tr>
                                                ...
                                                <td>
                                                    @php
                                                        $totalComment = (new Assignment\Php2News\Models\Comments)
                                                        ->getAllCommentByIDPost($post['id'])
                                                    @endphp
                                                    <span
                                                        class="badge {{ $totalComment ? 'badge-danger' : 'badge-default' }}"
                                                ...
                                                <td>
                                                    <a href='/admin/comments/list/{{ $post['id'] }}'
                                                        class='btn btn-warning waves-effect waves-light' data-toggle='tooltip'
                                                        data-placement='top' title='' data-original-title='Detail Post Comments'>
